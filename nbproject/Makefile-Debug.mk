...
${OBJECTDIR}/lib/fs/Uci/Uci.o: lib/fs/Uci/Uci.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib -Itest -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/fs/Uci/Uci.o lib/fs/Uci/Uci.cpp

${OBJECTDIR}/lib/fs/Uci/UciSection.o: lib/fs/Uci/UciSection.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/fs/Uci
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib -Itest -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/fs/Uci/UciSection.o lib/fs/Uci/UciSection.cpp
...
${OBJECTDIR}/test/string_test.o: test/string_test.cpp
	${MKDIR} -p ${OBJECTDIR}/test
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib -Itest -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/string_test.o test/string_test.cpp

${OBJECTDIR}/test/uci_cmd_test.o: test/uci_cmd_test.cpp
	${MKDIR} -p ${OBJECTDIR}/test
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib -Itest -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/uci_cmd_test.o test/uci_cmd_test.cpp

${OBJECTDIR}/test/uci_test.o: test/uci_test.cpp
	${MKDIR} -p ${OBJECTDIR}/test
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib -Itest -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/uci_test.o test/uci_test.cpp
